...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-white text-zinc-900 dark:from-zinc-950 dark:to-black dark:text-zinc-100">
      {/* NAVBAR */}
      <header className="sticky top-0 z-50 backdrop-blur bg-white/70 border-b border-zinc-200 dark:bg-zinc-950/70 dark:border-zinc-800">
        <nav className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
          <a href="#home" className="font-bold text-xl tracking-tight">Harsha Vardhan</a>
          <ul className="hidden md:flex gap-6 text-sm">
            <li><a className="hover:text-zinc-600 dark:hover:text-zinc-300" href="#projects">Projects</a></li>
            <li><a className="hover:text-zinc-600 dark:hover:text-zinc-300" href="#experience">Experience</a></li>
            <li><a className="hover:text-zinc-600 dark:hover:text-zinc-300" href="#skills">Skills</a></li>
            <li><a className="hover:text-zinc-600 dark:hover:text-zinc-300" href="#contact">Contact</a></li>
          </ul>
      ...
      <section id="home" className="mx-auto max-w-6xl px-4 py-16">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-3 py-1 text-xs mb-4 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <p className="mt-4 text-zinc-600 text-base md:text-lg dark:text-zinc-300">
            ...
            <div className="mt-6 flex gap-3">
              ...
              <a
                ...
                className="rounded-2xl px-5 py-2.5 border border-zinc-300 hover:bg-zinc-100 dark:border-zinc-700 dark:hover:bg-zinc-800"
              >
                GitHub Profile
              </a>
            </div>
            <div className="mt-6 flex items-center gap-6 text-sm text-zinc-500 dark:text-zinc-400">
              <span>Node.js</span>
              <span>React</span>
      ...
      {/* PROJECTS */}
      <section id="projects" className="bg-white border-t border-b border-zinc-200 dark:bg-zinc-950 dark:border-zinc-800">
        <div className="mx-auto max-w-6xl px-4 py-14">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((p) => (
              <article
                key={p.title}
                className="group rounded-3xl border border-zinc-200 bg-white p-5 shadow-sm hover:shadow-md transition-shadow dark:border-zinc-800 dark:bg-zinc-900"
              >
                <div className="aspect-video rounded-2xl bg-gradient-to-br from-zinc-100 to-zinc-50 mb-4 dark:from-zinc-800 dark:to-zinc-900" />
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {p.stack.map((s) => (
                    <span
                      key={s}
                      className="text-xs rounded-full border border-zinc-200 bg-zinc-50 px-2 py-0.5 dark:border-zinc-700 dark:bg-zinc-800"
                    >
                      {s}
                    </span>
                  ))}
                ...
                <div className="mt-4 flex gap-3 text-sm">
                  <a
                    href={p.demo}
                    className="rounded-full px-3 py-1.5 bg-zinc-900 text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
                  >
                    Live
                  </a>
                  <a
                    href={p.code}
                    className="rounded-full px-3 py-1.5 border border-zinc-300 hover:bg-zinc-100 dark:border-zinc-700 dark:hover:bg-zinc-800"
                  >
                    Code
                  </a>
                </div>
        ...
        <ol className="relative border-s border-zinc-200 dark:border-zinc-800">
          {[
            ...
            <li key={i} className="mb-8 ms-4">
              <div className="absolute w-3 h-3 bg-zinc-900 rounded-full mt-2 -start-1.5 border border-white dark:border-zinc-900" />
              <h3 className="font-semibold">
                {e.role} • <span className="text-zinc-600 dark:text-zinc-300">{e.org}</span>
              </h3>
              <p className="text-sm text-zinc-500 dark:text-zinc-400">{e.time}</p>
              <ul className="list-disc ms-5 mt-2 text-sm text-zinc-700 dark:text-zinc-300 space-y-1">
                {e.points.map((pt) => (
                  <li key={pt}>{pt}</li>
                ))}
              </ul>
      ...
      {/* SKILLS */}
      <section id="skills" className="bg-white border-t border-b border-zinc-200 dark:bg-zinc-950 dark:border-zinc-800">
        <div className="mx-auto max-w-6xl px-4 py-14">
          ...
          <div className="flex flex-wrap gap-2">
            {skills.map((s) => (
              <span
                key={s}
                className="rounded-full border border-zinc-200 bg-zinc-50 px-3 py-1 text-sm dark:border-zinc-700 dark:bg-zinc-800"
              >
                {s}
              </span>
            ))}
      ...
      {/* FOOTER */}
      <footer className="mx-auto max-w-6xl px-4 py-10 text-sm text-zinc-500 dark:text-zinc-400">
